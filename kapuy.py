...
root.mainloop()'''
    if not any(entry["name"] == "student_info.py" for entry in activities_log):
        log_activity("student_info.py", "(Activities)", ".py", student_code)
...
root.mainloop()'''
    if not any(entry["name"] == "receipt_generator.py" for entry in activities_log):
        log_activity("receipt_generator.py", "(Activities)", ".py", receipt_code)
    start_login()
